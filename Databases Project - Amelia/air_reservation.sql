...
ALTER TABLE `flight` CHANGE `price` to`baseprice` DECIMAL(10,0) NOT NULL;
...
ALTER TABLE `customer` CHANGE `password` `password_hash` VARCHAR(255);

ALTER TABLE `staff` ADD COLUMN `staff_reg_hash` VARCHAR(255) NOT NULL;